<script>
	...
	import SidebarItem from './NavItem.svelte'
</script>

<!-- 
<SidebarItem class="dropdown">
	<Button
	...
	<div id="navbar-components" slot="menu" class="dropdown-menu">
...
<Nav>
	<Dropdown>
		...
		<DropdownMenu>
			...
			<DropdownItem icon="star" href="/components/alerts">Alerts</DropdownItem>
		</DropdownMenu>
	</Dropdown>
	<Dropdown>
