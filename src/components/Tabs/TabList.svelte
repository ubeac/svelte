<script lang="ts">
	import { El, type TabListProps } from '$lib/components/index.js'
	...
	/**
	 * Whether the tabs grow to fill the available space
	 * @default undefined
	 * @type boolean
	 */
...
<El {...$$restProps} {...props} {cssPrefix} {cssProps}>
	<slot />
</El>
