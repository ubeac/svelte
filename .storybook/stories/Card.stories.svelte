...
<Story name="padding">
	<Card padding="sm">
		<Card.Body>Card with `sm` padding</Card.Body>
	</Card>
	<br />
	<Card padding="md">
		<Card.Body>Card with `md` padding</Card.Body>
	</Card>
	<br />
	<Card padding="lg">
		<Card.Body>Card with `lg` padding</Card.Body>
	</Card>
</Story>
<Story name="flat">
	<Card>
		<Card.Body>With Elevation</Card.Body>
	</Card>
	<br />
	<Card elevation={0}>
		<Card.Body>Without Elevation</Card.Body>
	</Card>
</Story>
<Story name="tile">
	<Card tile>
		<Card.Body>With Tile</Card.Body>
	</Card>
	<br />
	<Card>
		<Card.Body>Without Tile</Card.Body>
	</Card>
</Story>
<Story name="header">
	<Card>
...
<Story name="status">
	...
	<Card>
		...
		<Card.Status color="green" placement="start" />
	</Card>
	<br />
	<Card>
		<Card.Body>
		...
		<Card.Status color="blue" placement="bottom" />
	</Card>
</Story>
<Story name="stamp">
	<Card>
		...
		<Card.Stamp size="sm" placement="end" color="yellow">
			<Icon name="bell" />
		</Card.Stamp>
	</Card>
	<br />
	<Card>
		...
		<Card.Stamp size="md" placement="end" color="yellow">
			<Icon name="bell" />
		</Card.Stamp>
	</Card>
	<br />
	<Card>
		...
		<Card.Stamp size="lg" placement="end" color="yellow">
			<Icon name="bell" />
		</Card.Stamp>
	</Card>
</Story>
