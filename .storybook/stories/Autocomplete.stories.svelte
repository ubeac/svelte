...
<Meta title="Components/Input/Autocomplete" component={Autocomplete} />

<Template let:args>
	<Autocomplete items={items1} {...args} />
	<Autocomplete items={items2} {...args} />
	<Autocomplete items={items3} key="value" {...args} />
	<Autocomplete items={items4} {...args} />
</Template>
